      ...
      <body className="min-h-screen bg-base-100 font-mono">
        ...
        <footer className="container mx-auto px-6 py-6 opacity-60 text-xs text-center mt-auto">
          ...
          <div className="fab fab-flower">
            ...
            <div tabIndex={0} role="button" className="btn btn-circle btn-lg glass">
              <svg
                aria-label="New"
            ...
            <button className="fab-main-action btn btn-circle btn-lg btn-primary glass">
              <svg
                aria-label="New post"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 16 16"
            ...
            <button className="btn btn-circle btn-lg glass">
              <svg
