...
export function PdfViewer({ filename }: PdfViewerProps) {
    ...
    return (
      <div className="card card-border border-base-content/10 bg-base-200/30 backdrop-blur-sm">
        <div className="card-body items-center text-center py-16">
          ...
          <h3 className="font-family-mono text-accent text-lg">{filename}</h3>
  ...
  return (
    <div className="border border-base-content/10 bg-base-200/20 rounded-sm p-4 shadow-[inset_0_1px_8px_rgba(0,0,0,0.4)]">
      {/* PDF Document */}
      ...
      {/* Paginator */}
      <div className="flex items-center justify-center gap-3 mt-4 font-family-mono text-sm">
        <button
